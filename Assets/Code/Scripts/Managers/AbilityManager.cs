...
public class AbilityManager : MonoBehaviour
{
    ...
    // *********** SLOW ALL ENEMIES ***********
    private IEnumerator ApplySlowEffect(AbilityDataObject ability)
    {
    ...
    private IEnumerator ActivateBigJayRampage(AbilityDataObject ability)
    {
    ...
    public void ActivateAbility(AbilityDataObject ability)
    {
        switch (ability.Type)
        {
            case AbilityDataObject.AbilityType.SlowAll:
                StartCoroutine(ApplySlowEffect(ability));
                break;

            case AbilityDataObject.AbilityType.FreezeAll:
                StartCoroutine(ApplyFreezeEffect(ability.EffectDuration));
                break;

            case AbilityDataObject.AbilityType.BigJayRampage:
                StartCoroutine(ActivateBigJayRampage(ability));
                break;
        }
    }

    public void StartEffectRoutine(AbilityButtonController abilityButtonController, AbilityDataObject abilityData)
    {
        StartCoroutine(EffectRoutine(abilityButtonController, abilityData));
    }

    private IEnumerator EffectRoutine(AbilityButtonController abilityButtonController, AbilityDataObject abilityData)
    {
    ...
    private IEnumerator CooldownRoutine(AbilityButtonController abilityButtonController, AbilityDataObject abilityData)
    {
